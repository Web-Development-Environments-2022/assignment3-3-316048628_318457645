            ...
            <b-modal id="modal-center" centered title="Vue Bootstrap Centered Modal Example">
                <div class="my-4">
                    ...
                    <b-form @submit.prevent="onRegister" @reset.prevent="onReset">
                        <b-form-group id="input-group-username" label-cols-sm="3" label="Username:"
                            label-for="username">
                        ...
                        <b-form-group id="input-group-firstname" label-cols-sm="3" label="First name:"
                            label-for="firstname">
                        ...
                        <b-form-group id="input-group-lastname" label-cols-sm="3" label="Last name:"
                            label-for="lastname">
                        ...
                        <b-form-group id="input-group-Password" label-cols-sm="3" label="Password:"
                            label-for="password">
                        ...
                        <b-form-group id="input-group-confirmedPassword" label-cols-sm="3" label="Confirm Password:"
                            ...
                            <b-form-input id="confirmedPassword" type="password"
                                v-model="$v.form.confirmedPassword.$model" :state="validateState('confirmedPassword')">
                            </b-form-input>
                        ...
                        <b-form-group id="input-group-email" label-cols-sm="3" label="Email:" label-for="email">
                            <b-form-input id="email" type="text" v-model="$v.form.email.$model"
      ...
      try {
        const response = await this.axios.post(
...

          {
            ...
            readyInMinutes: this.form.firstname,
            imageUrl: this.form.lastname,
            popularity : this.form.country,
            vegan: this.form.password,
            vegetarian: this.form.email,
            // glutenFree: ,
            // ingredients: ,
            // instructions: ,
            // numOfServings
